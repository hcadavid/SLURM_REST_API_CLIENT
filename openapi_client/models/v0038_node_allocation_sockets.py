...
class V0038NodeAllocationSockets(BaseModel):
    """
    assignment status of each socket by numeric socket id
    """ # noqa: E501
    cores: Optional[Dict[str, Any]] = Field(default=None, description="assignment status of each core by core id in each socket")
    __properties: ClassVar[List[str]] = ["cores"]
