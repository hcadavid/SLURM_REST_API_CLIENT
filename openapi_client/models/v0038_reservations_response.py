...
class V0038ReservationsResponse(BaseModel):
    """
    ...
    reservations: Optional[List[V0038Reservation]] = Field(default=None, description="reservation info")
    __properties: ClassVar[List[str]] = ["meta", "errors", "reservations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "meta": V0038Meta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "errors": [V0038Error.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None,
            "reservations": [V0038Reservation.from_dict(_item) for _item in obj["reservations"]] if obj.get("reservations") is not None else None
        })
        return _obj
