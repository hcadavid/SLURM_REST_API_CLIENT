...
class V0038Meta(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "plugin": V0038MetaPlugin.from_dict(obj["plugin"]) if obj.get("plugin") is not None else None,
            "Slurm": V0038MetaSlurm.from_dict(obj["Slurm"]) if obj.get("Slurm") is not None else None
        })
        return _obj
