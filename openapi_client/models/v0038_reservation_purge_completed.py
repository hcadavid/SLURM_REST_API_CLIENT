...
class V0038ReservationPurgeCompleted(BaseModel):
    """
    If PURGE_COMP flag is set the amount of seconds this reservation will sit idle until it is revoked
    """ # noqa: E501
    time: Optional[StrictInt] = Field(default=None, description="amount of seconds this reservation will sit idle until it is revoked")
