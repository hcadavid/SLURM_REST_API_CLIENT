...
class V0038Reservation(BaseModel):
    """
    V0038Reservation
    """ # noqa: E501
    ...
    purge_completed: Optional[V0038ReservationPurgeCompleted] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "purge_completed": V0038ReservationPurgeCompleted.from_dict(obj["purge_completed"]) if obj.get("purge_completed") is not None else None,
